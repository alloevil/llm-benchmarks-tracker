...
| [FrontierMath](https://epoch.ai/benchmarks/frontiermath-tiers-1-3-v2) | 2024-11 | math, reasoning, research | saturating | 93.7% (Tiers 1-3 (v2)) | gpt-6-astra (max) | [独立复现](https://epoch.ai/benchmarks/frontiermath-tiers-1-3-v2) |
...
| [Tool Decathlon (Toolathlon)](https://toolathlon.xyz/docs/leaderboard) | 2025-10 | tool-use, general-assistant, software-engineering | active | 78.4% (verified) | GLM 5.3 Flash (max) | [官方榜单](https://toolathlon.xyz/docs/leaderboard) |
| [SWE-Bench Pro](https://labs.scale.com/leaderboard/swe_bench_pro_public) | 2025-09 | software-engineering, code, tool-use | active | 61.5% (public) | Muse Spark 1.1 | [官方榜单](https://labs.scale.com/leaderboard/swe_bench_pro_public) |
| [tau2-bench](https://taubench.com/leaderboard?benchmark=core) | 2025-06 | tool-use, instruction-following, general-assistant | active | 87.9% (core) | Qwen3.5-397B-A17B | [官方榜单](https://taubench.com) |
...
| [PaperBench](https://github.com/openai/frontier-evals/tree/main/project/paperbench) | 2025-04 | research, ml-engineering, code, tool-use | active | 43.4% (code-dev) | IterativeAgent o1-high | [官方榜单](https://github.com/openai/frontier-evals/tree/main/project/paperbench) |
...
| [OSWorld](https://os-world.github.io) | 2024-04 | computer-use, multimodal, tool-use | active | 90.19% (verified) | Intelligence-Indeed Agent | [官方榜单](https://os-world.github.io) |
...
| [GAIA](https://huggingface.co/spaces/gaia-benchmark/leaderboard) | 2023-11 | general-assistant, tool-use, web, reasoning, multimodal | saturating | 93.36% (test) | CustomGPT.ai Research Lab v44 | [官方榜单](https://huggingface.co/spaces/gaia-benchmark/leaderboard) |
